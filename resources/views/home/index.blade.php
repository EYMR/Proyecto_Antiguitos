            ...
            <div class="col">
                <div class="card-group">
                    <div class="card text-dark bg-light mb-3">
                        ...
                        <img src="http://127.0.0.1:8001/resources/img/users.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card text-dark bg-light mb-3">
                        ...
                        <img src="../Inventarios/Img/4016257.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <a href="../Inventarios/Productos.php" class="btn btn-primary" class="btn">Entrar</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card-group">
                    <div class="card text-dark bg-light mb-3">
                        ...
                        <img src="../Inventarios/Img/20943991.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card text-dark bg-light mb-3">
                        ...
                        <img src="../Inventarios/Img/4670240.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card text-dark bg-light mb-3">
                        ...
                        <img src="../Inventarios/Img/3094324.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
